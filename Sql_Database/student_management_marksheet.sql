...
CREATE TABLE `marksheet` (
  ...
  CONSTRAINT `marksheet_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`),
  CONSTRAINT `marksheet_ibfk_2` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`)
